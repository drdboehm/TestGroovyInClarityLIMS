...
class GLSRestApiUtils {
	...
	/**
	 * FIXME: delete when finished testing
	 * 
	 * @param url
	 * @param username
	 * @param password
	 ...
	 */
	@Deprecated
	static Node bakHttpGET(String url, String username, String password) {
		println "httpGET: " + url;
		URLConnection connection = getConnection(url, username, password)

		String xml = XmlParser().parse(connection.getInputStream());
